  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('내 근처'),
        actions: [
          IconButton(onPressed: (){}, icon: const Icon(CupertinoIcons.pencil), color: Colors.black,),
          IconButton(onPressed: (){}, icon: const Icon(CupertinoIcons.bell), color: Colors.black,),
        ],
      ...
      body: ListView(
        children: [
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Center(
                  child: RoundBorderText(title: searchKeyword[index], position: index),
                );
              },
            ),
          ),
          ...
          child: Text('이웃들의 추천가게', style: textTheme().headline2,),
          ),
